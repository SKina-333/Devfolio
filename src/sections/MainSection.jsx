      ...
      >
        <h3 className="font-Poppins text-center cursor-default">
          {["S", "o", "k", "i", "n", "a", " ", "H", "o"].map((char, index) => (
            <span
              key={index}
              className="inline-block text-8xl font-bold transform transition-transform duration-200 ease-in-out hover:-translate-y-4  hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r from-[#0093E9] to-[#80D0C7] to-60%"
            >
              {char}
            </span>
          ))}
        </h3>
        <p className="font-Poppins text-3xl relative left-20 cursor-default">
          A{" "}
